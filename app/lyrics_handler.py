from app.azure_translate_api import create_translation_map, get_translation_for_original
import logging

def trim_lyrics(lyrics):
    ''' Removes the empty lines before and after the lyrics. Returns everything in between. '''
    lines = lyrics.split('\n')
