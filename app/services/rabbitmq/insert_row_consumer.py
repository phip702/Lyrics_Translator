...
def consume_from_rabbitmq(queue_name):
    connection = pika.BlockingConnection(pika.ConnectionParameters('rabbitmq')) #consumer
...
def start_consumer():
    consume_from_rabbitmq("insert_track_queue")
    consume_from_rabbitmq("Testing")


if __name__ == "__main__":
    
    consume_from_rabbitmq("Testing==========Consuming")